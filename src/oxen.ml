...
module Make (Action : Action_intf.S) : S with module Action = Action = struct
  ...
  let provide_environment state environment =
    ...
    | Ready_for_feedback _ ->
        invalid_arg "Oxen.provide_environment: This state must be used with Oxen.provide_feedback"
  ...
  let provide_feedback ~reward ~is_final_step state =
    ...
    | Ready_for_environment _ ->
        invalid_arg "Oxen.provide_feedback: This state must be used with Oxen.provide_environment"
